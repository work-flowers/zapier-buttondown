const perform = async (z, bundle) => {
  ...
  return (response.data.results || [])
    .filter((s) => s.unsubscription_date)
    .map((s) => ({
      ...s,
      subscriber_id: s.id,
      id: `${s.id}:${s.unsubscription_date}`,
    }));
};
...
module.exports = {
  ...
  operation: {
    perform,
    sample: {
      id: 'sub_00000000-0000-0000-0000-000000000000:2026-04-06T12:00:00Z',
      subscriber_id: 'sub_00000000-0000-0000-0000-000000000000',
    ...
    outputFields: [
      ...
      { key: 'subscriber_id', label: 'Subscriber ID', type: 'string' },
      ...
      {
        key: 'unsubscription_date',
        label: 'Unsubscribe Date',
        type: 'datetime',
      },
      {
        key: 'unsubscription_reason',
